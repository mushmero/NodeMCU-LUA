...
local function mqtt_start()  
    m = mqtt.Client(config.ID, 300,config.USERNAME,config.PASSWORD)
    ...
    m:connect(config.HOST, config.PORT, 0, function(con)  --remove autoreconnect since API is deprecated
